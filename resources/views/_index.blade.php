...
<html lang="en">
   ...
   <body class="main-layout">
      ...
      <!-- top -->
       ...
       <!-- header -->
       <header class="header-area" style="background-color: rgb(72, 196, 185)">
         <div class="left">
            <a href="{{ Route('home') }}">
     
               <i class="fa fa-hourglass-start fa-4x" aria-hidden="true"  style="margin-top: 20%"></i>
            </a>
         </div>
         <div class="right">
            @if (Auth::check())
            <a href="{{Route('logout')}}"><i class="fa fa-user" aria-hidden="true"> Logout</i></a> 
            @else
            <a href="{{Route('register')}}"><i class="fa fa-user" aria-hidden="true"> Register</i></a> 
            @endif
                  ...
                  <div class="navbar-area">
                     <nav class="site-navbar">
                        <ul>
                           ...
                           @foreach (getTopFiveActiveCategories() as $category)
               ...
               <div class="row">
                     ...
                     <div class="col-lg-4 col-md-6 col-sm-6">
                           <div class="hedingh3 text_align_left">
                              <h3>countrys</h3>
                              <div class="map">
                                <img src="/front/images/map.png" alt="#"/>
                              </div>
                           </div>
                        </div>
